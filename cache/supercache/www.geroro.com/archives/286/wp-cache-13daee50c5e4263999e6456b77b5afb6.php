...
<title>HTTP | GERORO</title>
<link rel="profile" href="http://gmpg.org/xfn/11" />
<link rel="pingback" href="http://www.geroro.com/xmlrpc.php" />

<!-- All in One SEO Pack 2.3.14.2 by Michael Torbert of Semper Fi Web Designob_start_detected [-1,-1] -->
<meta name="description"  content="HTTP状态码详解" />

<meta name="keywords"  content="http,php" />

<link rel="canonical" href="http://www.geroro.com/archives/286" />
<!-- /all in one seo pack -->
...
<link rel="alternate" type="application/rss+xml" title="GERORO &raquo; HTTP状态码详解评论Feed" href="http://www.geroro.com/archives/286/feed" />
...
<link rel='prev' title='wordpress常用的调用代码' href='http://www.geroro.com/archives/278' />
<link rel='next' title='深秋初冬' href='http://www.geroro.com/archives/324' />
<meta name="generator" content="WordPress 4.8" />
<link rel='shortlink' href='http://wp.me/p7iM5K-4C' />
<link rel="alternate" type="application/json+oembed" href="http://www.geroro.com/wp-json/oembed/1.0/embed?url=http%3A%2F%2Fwww.geroro.com%2Farchives%2F286" />
<link rel="alternate" type="text/xml+oembed" href="http://www.geroro.com/wp-json/oembed/1.0/embed?url=http%3A%2F%2Fwww.geroro.com%2Farchives%2F286&#038;format=xml" />
...
<meta property="og:title" content="HTTP状态码详解" />
<meta property="og:url" content="http://www.geroro.com/archives/286" />
<meta property="og:description" content="大家都知道404是木有找到东西，301是定义转向，但又有几个人知道206或者307呢？本文就给大家列出了各种H&hellip;" />
<meta property="article:published_time" content="2016-11-21T14:35:59+00:00" />
<meta property="article:modified_time" content="2017-03-12T08:33:52+00:00" />
<meta property="og:site_name" content="GERORO" />
<meta property="og:image" content="https://i2.wp.com/www.geroro.com/wp-content/uploads/2016/11/2fdda3cc7cd98d10b262fca2233fb80e7aec90eb.png?fit=500%2C454" />
<meta property="og:image:width" content="500" />
<meta property="og:image:height" content="454" />
<meta property="og:locale" content="zh_CN" />
<meta name="twitter:image" content="https://i2.wp.com/www.geroro.com/wp-content/uploads/2016/11/2fdda3cc7cd98d10b262fca2233fb80e7aec90eb.png?fit=500%2C454&#038;w=640" />
...
<body class="post-template-default single single-post postid-286 single-format-standard mobile-theme elementor-default">
<div id="wrapper">
...
<li id="menu-item-193" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-193"><a href="http://www.geroro.com/about">关于</a></li>
	...
	<article id="post-286" class="post-286 post type-post status-publish format-standard has-post-thumbnail hentry category-php tag-php">
		<header class="entry-header">
									<h1 class="entry-title"><a href="http://www.geroro.com/archives/286" rel="bookmark">HTTP状态码详解</a></h1>
		...
		<div class="entry-content">
					<p style="box-sizing: border-box; margin-top: 0px; margin-bottom: 18px; word-wrap: break-word; color: rgb(85, 85, 85); font-family: &#39;Microsoft Yahei&#39;; font-size: 15px; line-height: 25px; white-space: normal; background-color: rgb(255, 255, 255);">大家都知道404是木有找到东西，301是定义转向，但又有几个人知道206或者307呢？本文就给大家列出了各种HTTP状态码的含义，适合长期收藏。</p>
<table width="778">
<tbody style="box-sizing: border-box;">
<tr style="box-sizing: border-box;" class="ue-table-interlace-color-single firstRow">
<th width="70" style="box-sizing: border-box; text-align: center; background-color: rgb(146, 205, 220);" class="selectTdClass">状态代码</th>
<th width="120" style="box-sizing: border-box; text-align: center; background-color: rgb(146, 205, 220);" class="selectTdClass">状态信息</th>
<th style="box-sizing: border-box; text-align: center; background-color: rgb(146, 205, 220);" class="selectTdClass">含义</th>
</tr>
<tr style="box-sizing: border-box;" class="ue-table-interlace-color-double">
<td style="box-sizing: border-box; background-color: rgb(187, 187, 187);">100</td>
<td style="box-sizing: border-box; background-color: rgb(187, 187, 187);">Continue</td>
<td style="box-sizing: border-box; background-color: rgb(187, 187, 187);">初始的请求已经接受，客户应当继续发送请求的其余部分。（HTTP 1.1新）</td>
</tr>
<tr style="box-sizing: border-box;" class="ue-table-interlace-color-single">
<td style="box-sizing: border-box; background-color: rgb(204, 204, 204);">101</td>
<td style="box-sizing: border-box; background-color: rgb(204, 204, 204);">Switching Protocols</td>
<td style="box-sizing: border-box; background-color: rgb(204, 204, 204);">服务器将遵从客户的请求转换到另外一种协议（HTTP 1.1新）</td>
</tr>
<tr style="box-sizing: border-box;" class="ue-table-interlace-color-double">
<td style="box-sizing: border-box; background-color: rgb(187, 187, 187);">200</td>
<td style="box-sizing: border-box; background-color: rgb(187, 187, 187);">OK</td>
<td style="box-sizing: border-box; background-color: rgb(187, 187, 187);">一切正常，对GET和POST请求的应答文档跟在后面。</td>
</tr>
<tr style="box-sizing: border-box;" class="ue-table-interlace-color-single">
<td style="box-sizing: border-box; background-color: rgb(204, 204, 204);">201</td>
<td style="box-sizing: border-box; background-color: rgb(204, 204, 204);">Created</td>
<td style="box-sizing: border-box; background-color: rgb(204, 204, 204);">服务器已经创建了文档，Location头给出了它的URL。</td>
</tr>
<tr style="box-sizing: border-box;" class="ue-table-interlace-color-double">
<td style="box-sizing: border-box; background-color: rgb(187, 187, 187);">202</td>
<td style="box-sizing: border-box; background-color: rgb(187, 187, 187);">Accepted</td>
<td style="box-sizing: border-box; background-color: rgb(187, 187, 187);">已经接受请求，但处理尚未完成。</td>
</tr>
<tr style="box-sizing: border-box;" class="ue-table-interlace-color-single">
<td style="box-sizing: border-box; background-color: rgb(204, 204, 204);">203</td>
<td style="box-sizing: border-box; background-color: rgb(204, 204, 204);">Non-Authoritative Information</td>
<td style="box-sizing: border-box; background-color: rgb(204, 204, 204);">文档已经正常地返回，但一些应答头可能不正确，因为使用的是文档的拷贝（HTTP 1.1新）。</td>
</tr>
<tr style="box-sizing: border-box;" class="ue-table-interlace-color-double">
<td style="box-sizing: border-box; background-color: rgb(187, 187, 187);">204</td>
<td style="box-sizing: border-box; background-color: rgb(187, 187, 187);">No Content</td>
<td style="box-sizing: border-box; background-color: rgb(187, 187, 187);">没有新文档，浏览器应该继续显示原来的文档。如果用户定期地刷新页面，而Servlet可以确定用户文档足够新，这个状态代码是很有用的。</td>
</tr>
<tr style="box-sizing: border-box;" class="ue-table-interlace-color-single">
<td style="box-sizing: border-box; background-color: rgb(204, 204, 204);">205</td>
<td style="box-sizing: border-box; background-color: rgb(204, 204, 204);">Reset Content</td>
<td style="box-sizing: border-box; background-color: rgb(204, 204, 204);">没有新的内容，但浏览器应该重置它所显示的内容。用来强制浏览器清除表单输入内容（HTTP 1.1新）。</td>
</tr>
<tr style="box-sizing: border-box;" class="ue-table-interlace-color-double">
<td style="box-sizing: border-box; background-color: rgb(187, 187, 187);">206</td>
<td style="box-sizing: border-box; background-color: rgb(187, 187, 187);">Partial Content</td>
<td style="box-sizing: border-box; background-color: rgb(187, 187, 187);">客户发送了一个带有Range头的GET请求，服务器完成了它（HTTP 1.1新）。</td>
</tr>
<tr style="box-sizing: border-box;" class="ue-table-interlace-color-single">
<td style="box-sizing: border-box; background-color: rgb(204, 204, 204);">300</td>
<td style="box-sizing: border-box; background-color: rgb(204, 204, 204);">Multiple Choices</td>
<td style="box-sizing: border-box; background-color: rgb(204, 204, 204);">客户请求的文档可以在多个位置找到，这些位置已经在返回的文档内列出。如果服务器要提出优先选择，则应该在Location应答头指明。</td>
</tr>
<tr style="box-sizing: border-box;" class="ue-table-interlace-color-double">
<td style="box-sizing: border-box; background-color: rgb(187, 187, 187);">301</td>
<td style="box-sizing: border-box; background-color: rgb(187, 187, 187);">Moved Permanently</td>
<td style="box-sizing: border-box; background-color: rgb(187, 187, 187);">客户请求的文档在其他地方，新的URL在Location头中给出，浏览器应该自动地访问新的URL。</td>
</tr>
<tr style="box-sizing: border-box;" class="ue-table-interlace-color-single">
<td style="box-sizing: border-box; background-color: rgb(204, 204, 204);">302</td>
<td style="box-sizing: border-box; background-color: rgb(204, 204, 204);">Found</td>
<td style="box-sizing: border-box; background-color: rgb(204, 204, 204);">类似于301，但新的URL应该被视为临时性的替代，而不是永久性的。注意，在HTTP1.0中对应的状态信息是“Moved Temporatily”。出现该状态代码时，浏览器能够自动访问新的URL，因此它是一个很有用的状态代码。注意这个状态代码有时候可以和301替换使用。例如，如果浏览器错误地请求http://host/~user（缺少了后面的斜杠），有的服务器 返回301，有的则返回302。严格地说，我们只能假定只有当原来的请求是GET时浏览器才会自动重定向。请参见307。</td>
</tr>
<tr style="box-sizing: border-box;" class="ue-table-interlace-color-double">
<td style="box-sizing: border-box; background-color: rgb(187, 187, 187);">303</td>
<td style="box-sizing: border-box; background-color: rgb(187, 187, 187);">See Other</td>
<td style="box-sizing: border-box; background-color: rgb(187, 187, 187);">类似于301/302，不同之处在于，如果原来的请求是POST，Location头指定的重定向目标文档应该通过GET提取（HTTP 1.1新）。</td>
</tr>
<tr style="box-sizing: border-box;" class="ue-table-interlace-color-single">
<td style="box-sizing: border-box; background-color: rgb(204, 204, 204);">304</td>
<td style="box-sizing: border-box; background-color: rgb(204, 204, 204);">Not Modified</td>
<td style="box-sizing: border-box; background-color: rgb(204, 204, 204);">客户端有缓冲的文档并发出了一个条件性的请求（一般是提供If-Modified-Since头表示客户只想比指定日期更新的文档）。服务器告 诉客户，原来缓冲的文档还可以继续使用。</td>
</tr>
<tr style="box-sizing: border-box;" class="ue-table-interlace-color-double">
<td style="box-sizing: border-box; background-color: rgb(187, 187, 187);">305</td>
<td style="box-sizing: border-box; background-color: rgb(187, 187, 187);">Use Proxy</td>
<td style="box-sizing: border-box; background-color: rgb(187, 187, 187);">客户请求的文档应该通过Location头所指明的代理服务器提取（HTTP 1.1新）。</td>
</tr>
<tr style="box-sizing: border-box;" class="ue-table-interlace-color-single">
<td style="box-sizing: border-box; background-color: rgb(204, 204, 204);">307</td>
<td style="box-sizing: border-box; background-color: rgb(204, 204, 204);">Temporary Redirect</td>
<td style="box-sizing: border-box; background-color: rgb(204, 204, 204);">和302 （Found）相同。许多浏览器会错误地响应302应答进行重定向，即使原来的请求是POST，即使它实际上只能在POST请求的应答是303时才能重定 向。由于这个原因，HTTP 1.1新增了307，以便更加清除地区分几个状态代码：当出现303应答时，浏览器可以跟随重定向的GET和POST请求；如果是307应答，则浏览器只 能跟随对GET请求的重定向。（HTTP 1.1新）</td>
</tr>
<tr style="box-sizing: border-box;" class="ue-table-interlace-color-double">
<td style="box-sizing: border-box; background-color: rgb(187, 187, 187);">400</td>
<td style="box-sizing: border-box; background-color: rgb(187, 187, 187);">Bad Request</td>
<td style="box-sizing: border-box; background-color: rgb(187, 187, 187);">请求出现语法错误。</td>
</tr>
<tr style="box-sizing: border-box;" class="ue-table-interlace-color-single">
<td style="box-sizing: border-box; background-color: rgb(204, 204, 204);">401</td>
<td style="box-sizing: border-box; background-color: rgb(204, 204, 204);">Unauthorized</td>
<td style="box-sizing: border-box; background-color: rgb(204, 204, 204);">客户试图未经授权访问受密码保护的页面。应答中会包含一个WWW-Authenticate头，浏览器据此显示用户名字/密码对话框，然后在填 写合适的Authorization头后再次发出请求。</td>
</tr>
<tr style="box-sizing: border-box;" class="ue-table-interlace-color-double">
<td style="box-sizing: border-box; background-color: rgb(187, 187, 187);">403</td>
<td style="box-sizing: border-box; background-color: rgb(187, 187, 187);">Forbidden</td>
<td style="box-sizing: border-box; background-color: rgb(187, 187, 187);">资源不可用。服务器理解客户的请求，但拒绝处理它。通常由于服务器上文件或目录的权限设置导致。</td>
</tr>
<tr style="box-sizing: border-box;" class="ue-table-interlace-color-single">
<td style="box-sizing: border-box; background-color: rgb(204, 204, 204);">404</td>
<td style="box-sizing: border-box; background-color: rgb(204, 204, 204);">Not Found</td>
<td style="box-sizing: border-box; background-color: rgb(204, 204, 204);">无法找到指定位置的资源。这也是一个常用的应答。</td>
</tr>
<tr style="box-sizing: border-box;" class="ue-table-interlace-color-double">
<td style="box-sizing: border-box; background-color: rgb(187, 187, 187);">405</td>
<td style="box-sizing: border-box; background-color: rgb(187, 187, 187);">Method Not Allowed</td>
<td style="box-sizing: border-box; background-color: rgb(187, 187, 187);">请求方法（GET、POST、HEAD、DELETE、PUT、TRACE等）对指定的资源不适用。（HTTP 1.1新）</td>
</tr>
<tr style="box-sizing: border-box;" class="ue-table-interlace-color-single">
<td style="box-sizing: border-box; background-color: rgb(204, 204, 204);">406</td>
<td style="box-sizing: border-box; background-color: rgb(204, 204, 204);">Not Acceptable</td>
<td style="box-sizing: border-box; background-color: rgb(204, 204, 204);">指定的资源已经找到，但它的MIME类型和客户在Accpet头中所指定的不兼容（HTTP 1.1新）。</td>
</tr>
<tr style="box-sizing: border-box;" class="ue-table-interlace-color-double">
<td style="box-sizing: border-box; background-color: rgb(187, 187, 187);">407</td>
<td style="box-sizing: border-box; background-color: rgb(187, 187, 187);">Proxy Authentication Required</td>
<td style="box-sizing: border-box; background-color: rgb(187, 187, 187);">类似于401，表示客户必须先经过代理服务器的授权。（HTTP 1.1新）</td>
</tr>
<tr style="box-sizing: border-box;" class="ue-table-interlace-color-single">
<td style="box-sizing: border-box; background-color: rgb(204, 204, 204);">408</td>
<td style="box-sizing: border-box; background-color: rgb(204, 204, 204);">Request Timeout</td>
<td style="box-sizing: border-box; background-color: rgb(204, 204, 204);">在服务器许可的等待时间内，客户一直没有发出任何请求。客户可以在以后重复同一请求。（HTTP 1.1新）</td>
</tr>
<tr style="box-sizing: border-box;" class="ue-table-interlace-color-double">
<td style="box-sizing: border-box; background-color: rgb(187, 187, 187);">409</td>
<td style="box-sizing: border-box; background-color: rgb(187, 187, 187);">Conflict</td>
<td style="box-sizing: border-box; background-color: rgb(187, 187, 187);">通常和PUT请求有关。由于请求和资源的当前状态相冲突，因此请求不能成功。（HTTP 1.1新）</td>
</tr>
<tr style="box-sizing: border-box;" class="ue-table-interlace-color-single">
<td style="box-sizing: border-box; background-color: rgb(204, 204, 204);">410</td>
<td style="box-sizing: border-box; background-color: rgb(204, 204, 204);">Gone</td>
<td style="box-sizing: border-box; background-color: rgb(204, 204, 204);">所请求的文档已经不再可用，而且服务器不知道应该重定向到哪一个地址。它和404的不同在于，返回407表示文档永久地离开了指定的位置，而 404表示由于未知的原因文档不可用。（HTTP 1.1新）</td>
</tr>
<tr style="box-sizing: border-box;" class="ue-table-interlace-color-double">
<td style="box-sizing: border-box; background-color: rgb(187, 187, 187);">411</td>
<td style="box-sizing: border-box; background-color: rgb(187, 187, 187);">Length Required</td>
<td style="box-sizing: border-box; background-color: rgb(187, 187, 187);">服务器不能处理请求，除非客户发送一个Content-Length头。（HTTP 1.1新）</td>
</tr>
<tr style="box-sizing: border-box;" class="ue-table-interlace-color-single">
<td style="box-sizing: border-box; background-color: rgb(204, 204, 204);">412</td>
<td style="box-sizing: border-box; background-color: rgb(204, 204, 204);">Precondition Failed</td>
<td style="box-sizing: border-box; background-color: rgb(204, 204, 204);">请求头中指定的一些前提条件失败（HTTP 1.1新）。</td>
</tr>
<tr style="box-sizing: border-box;" class="ue-table-interlace-color-double">
<td style="box-sizing: border-box; background-color: rgb(187, 187, 187);">413</td>
<td style="box-sizing: border-box; background-color: rgb(187, 187, 187);">Request Entity Too Large</td>
<td style="box-sizing: border-box; background-color: rgb(187, 187, 187);">目标文档的大小超过服务器当前愿意处理的大小。如果服务器认为自己能够稍后再处理该请求，则应该提供一个Retry-After头（HTTP 1.1新）。</td>
</tr>
<tr style="box-sizing: border-box;" class="ue-table-interlace-color-single">
<td style="box-sizing: border-box; background-color: rgb(204, 204, 204);">414</td>
<td style="box-sizing: border-box; background-color: rgb(204, 204, 204);">Request URI Too Long</td>
<td style="box-sizing: border-box; background-color: rgb(204, 204, 204);">URI太长（HTTP 1.1新）。</td>
</tr>
<tr style="box-sizing: border-box;" class="ue-table-interlace-color-double">
<td style="box-sizing: border-box; background-color: rgb(187, 187, 187);">416</td>
<td style="box-sizing: border-box; background-color: rgb(187, 187, 187);">Requested Range Not Satisfiable</td>
<td style="box-sizing: border-box; background-color: rgb(187, 187, 187);">服务器不能满足客户在请求中指定的Range头。（HTTP 1.1新）</td>
</tr>
<tr style="box-sizing: border-box;" class="ue-table-interlace-color-single">
<td style="box-sizing: border-box; background-color: rgb(204, 204, 204);">500</td>
<td style="box-sizing: border-box; background-color: rgb(204, 204, 204);">Internal Server Error</td>
<td style="box-sizing: border-box; background-color: rgb(204, 204, 204);">服务器遇到了意料不到的情况，不能完成客户的请求。</td>
</tr>
<tr style="box-sizing: border-box;" class="ue-table-interlace-color-double">
<td style="box-sizing: border-box; background-color: rgb(187, 187, 187);">501</td>
<td style="box-sizing: border-box; background-color: rgb(187, 187, 187);">Not Implemented</td>
<td style="box-sizing: border-box; background-color: rgb(187, 187, 187);">服务器不支持实现请求所需要的功能。例如，客户发出了一个服务器不支持的PUT请求。</td>
</tr>
<tr style="box-sizing: border-box;" class="ue-table-interlace-color-single">
<td style="box-sizing: border-box; background-color: rgb(204, 204, 204);">502</td>
<td style="box-sizing: border-box; background-color: rgb(204, 204, 204);">Bad Gateway</td>
<td style="box-sizing: border-box; background-color: rgb(204, 204, 204);">服务器作为网关或者代理时，为了完成请求访问下一个服务器，但该服务器返回了非法的应答。</td>
</tr>
<tr style="box-sizing: border-box;" class="ue-table-interlace-color-double">
<td style="box-sizing: border-box; background-color: rgb(187, 187, 187);">503</td>
<td style="box-sizing: border-box; background-color: rgb(187, 187, 187);">Service Unavailable</td>
<td style="box-sizing: border-box; background-color: rgb(187, 187, 187);">服务器由于维护或者负载过重未能应答。例如，Servlet可能在数据库连接池已满的情况下返回503。服务器返回503时可以提供一个 Retry-After头。</td>
</tr>
<tr style="box-sizing: border-box;" class="ue-table-interlace-color-single">
<td style="box-sizing: border-box; background-color: rgb(204, 204, 204);">504</td>
<td style="box-sizing: border-box; background-color: rgb(204, 204, 204);">Gateway Timeout</td>
<td style="box-sizing: border-box; background-color: rgb(204, 204, 204);">由作为代理或网关的服务器使用，表示不能及时地从远程服务器获得应答。（HTTP 1.1新）</td>
</tr>
<tr style="box-sizing: border-box;" class="ue-table-interlace-color-double">
<td style="box-sizing: border-box; background-color: rgb(187, 187, 187);">505</td>
<td style="box-sizing: border-box; background-color: rgb(187, 187, 187);">HTTP Version Not Supported</td>
<td style="box-sizing: border-box; background-color: rgb(187, 187, 187);">服务器不支持请求中所指明的HTTP版本。（HTTP 1.1新）</p>
</td>
</tr>
</tbody>
</table>
...
<div class="addtoany_share_save_container addtoany_content_bottom"><div class="a2a_kit a2a_kit_size_22 addtoany_list" data-a2a-url="http://www.geroro.com/archives/286" data-a2a-title="HTTP状态码详解"><a class="a2a_button_wechat" href="https://www.addtoany.com/add_to/wechat?linkurl=http%3A%2F%2Fwww.geroro.com%2Farchives%2F286&amp;linkname=HTTP%E7%8A%B6%E6%80%81%E7%A0%81%E8%AF%A6%E8%A7%A3" title="WeChat" rel="nofollow noopener" target="_blank"></a><a class="a2a_button_qzone" href="https://www.addtoany.com/add_to/qzone?linkurl=http%3A%2F%2Fwww.geroro.com%2Farchives%2F286&amp;linkname=HTTP%E7%8A%B6%E6%80%81%E7%A0%81%E8%AF%A6%E8%A7%A3" title="Qzone" rel="nofollow noopener" target="_blank"></a><a class="a2a_button_sina_weibo" href="https://www.addtoany.com/add_to/sina_weibo?linkurl=http%3A%2F%2Fwww.geroro.com%2Farchives%2F286&amp;linkname=HTTP%E7%8A%B6%E6%80%81%E7%A0%81%E8%AF%A6%E8%A7%A3" title="Sina Weibo" rel="nofollow noopener" target="_blank"></a><a class="a2a_button_wordpress" href="https://www.addtoany.com/add_to/wordpress?linkurl=http%3A%2F%2Fwww.geroro.com%2Farchives%2F286&amp;linkname=HTTP%E7%8A%B6%E6%80%81%E7%A0%81%E8%AF%A6%E8%A7%A3" title="WordPress" rel="nofollow noopener" target="_blank"></a><a class="a2a_dd addtoany_share_save" href="https://www.addtoany.com/share"></a></div></div>							</div><!-- .entry-content -->

		<footer class="entry-meta">
							<span class="entry-date"><a href="http://www.geroro.com/archives/286" title="下午10:35" rel="bookmark"><time datetime="2016-11-21T22:35:59+00:00" pubdate>2016年11月21日</time></a></span>									<span class="comments-link"><a href="http://www.geroro.com/archives/286#respond"><span class="leave-reply">发表评论</span></a></span>
								</footer><!-- #entry-meta -->
	</article><!-- #post-286 -->

		<nav id="nav-single">
		<h3 class="assistive-text">文章导航</h3>
		<span class="nav-previous"><a href="http://www.geroro.com/archives/278" rel="prev">&laquo; 上一页</a></span>
		<span class="nav-next"><a href="http://www.geroro.com/archives/324" rel="next">下一页 &raquo;</a></span>
	</nav><!-- #nav-single -->
...
<div class="wp-social-login-widget">
	...
	<div class="wp-social-login-provider-list">
		...
		<a rel="nofollow" href="http://www.geroro.com/wp-login.php?action=wordpress_social_authenticate&#038;mode=login&#038;provider=WordPress&#038;redirect_to=http%3A%2F%2Fwww.geroro.com%2Farchives%2F286" title="Connect with WordPress" class="wp-social-login-provider wp-social-login-provider-wordpress" data-provider="WordPress">
		...
		<a rel="nofollow" href="http://www.geroro.com/wp-login.php?action=wordpress_social_authenticate&#038;mode=login&#038;provider=LinkedIn&#038;redirect_to=http%3A%2F%2Fwww.geroro.com%2Farchives%2F286" title="Connect with LinkedIn" class="wp-social-login-provider wp-social-login-provider-linkedin" data-provider="LinkedIn">
		...
		<a rel="nofollow" href="http://www.geroro.com/wp-login.php?action=wordpress_social_authenticate&#038;mode=login&#038;provider=Live&#038;redirect_to=http%3A%2F%2Fwww.geroro.com%2Farchives%2F286" title="Connect with Windows Live" class="wp-social-login-provider wp-social-login-provider-live" data-provider="Live">
...
<!-- wsl_render_auth_widget -->
                            ...
                            <input type="hidden" id="wpdiscuz_subscribe_form_nonce" name="wpdiscuz_subscribe_form_nonce" value="5dd6a98262" /><input type="hidden" name="_wp_http_referer" value="/archives/286" />                            <input type="hidden" value="286" name="wpdiscuzSubscriptionPostId" />
                        </form>
                                        <div class="wpdiscuz_clear"></div>
                                    </div>
...
<b>Warning</b>:  include(): Failed opening 'C:\web\geroro\wp-content\plugins\jetpack\modules/minileven/theme/pub/minileven/smiley.php' for inclusion (include_path='.;C:\php\pear') in <b>C:\web\geroro\wp-content\plugins\wpdiscuz\forms\wpdFormAttr\Form.php</b> on line <b>496</b><br />
            ...
            <div class="wc-label wc-captcha-label">
                                <a class="wpdiscuz-nofollow" href="#" rel="nofollow"><img alt="wpdiscuz_captcha" class="wc_captcha_img" src="http://www.geroro.com/wp-content/plugins/wpdiscuz/utils/temp/39s54-15009399580896.png"  width="80" height="26"/></a><a class="wpdiscuz-nofollow wc_captcha_refresh_img" href="#" rel="nofollow"><img  alt="refresh" class="" src="http://www.geroro.com/wp-content/plugins/wpdiscuz/assets/img/captcha-loading.png" width="16" height="16"/></a>
                <input type="hidden" id="39s54d921f2848f9e832ed554e910e59be90d1ce6e206e4f9f677446596aae8919704" class="wpdiscuz-cnonce" name="cnonce" value="39s54d921f2848f9e832ed554e910e59be90d1ce6e206e4f9f677446596aae8919704" />
            </div>
            <div class="clearfix"></div>
        </div>
...
<b>Warning</b>:  include(): Failed opening 'C:\web\geroro\wp-content\plugins\jetpack\modules/minileven/theme/pub/minileven/smiley.php' for inclusion (include_path='.;C:\php\pear') in <b>C:\web\geroro\wp-content\plugins\wpdiscuz\forms\wpdFormAttr\Form.php</b> on line <b>496</b><br />
            ...
            <div class="wc-label wc-captcha-label">
                                <a class="wpdiscuz-nofollow" href="#" rel="nofollow"><img alt="wpdiscuz_captcha" class="wc_captcha_img" src="http://www.geroro.com/wp-content/plugins/wpdiscuz/utils/temp/82YNc-15009399580934.png"  width="80" height="26"/></a><a class="wpdiscuz-nofollow wc_captcha_refresh_img" href="#" rel="nofollow"><img  alt="refresh" class="" src="http://www.geroro.com/wp-content/plugins/wpdiscuz/assets/img/captcha-loading.png" width="16" height="16"/></a>
                <input type="hidden" id="82YNcf354a87efcbfc58adf8810a041ee7761741af7240c1089b7a8e469da6e93f663" class="wpdiscuz-cnonce" name="cnonce" value="82YNcf354a87efcbfc58adf8810a041ee7761741af7240c1089b7a8e469da6e93f663" />
            </div>
            <div class="clearfix"></div>
        </div>
                <div class="wc-field-submit">
...
<footer id="colophon" role="contentinfo">
	<div id="site-generator">
		...
		<a href="http://www.geroro.com/archives/286/?ak_action=reject_mobile">查看全部站点</a><br />
...
<script type='text/javascript'>
	_stq = window._stq || [];
	_stq.push([ 'view', {v:'ext',j:'1:5.1',blog:'107909124',post:'286',tz:'8',srv:'www.geroro.com'} ]);
	_stq.push([ 'clickTrackerInit', '107909124', '286' ]);
</script>
<!-- Generated in 2.218 seconds. Made 36 queries to database and 50 cached queries. Memory used - 39.57MB -->
...
<!-- Cached page generated by WP-Super-Cache on 2017-07-25 07:45:58 -->
