...
class BackWPup_Page_Settings {
	...
	public static function save_post_form() {
		...
		if ( (int) $_POST[ 'jobmaxexecutiontime' ] > 1400 ) {
			$_POST[ 'jobmaxexecutiontime' ] = 1400;
		}
                    ...
                    <td>
                        <fieldset>
                            ...
                            <label for="jobmaxexecutiontime">
                                <input name="jobmaxexecutiontime" type="number" min="0" step="1" max="1440" id="jobmaxexecutiontime" value="<?php echo absint( get_site_option( 'backwpup_cfg_jobmaxexecutiontime' ) ); ?>" class="small-text" />
