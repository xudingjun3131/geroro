...
Tags:        Jayden major, widgets, custom home page, pages on widgets, page, page editor, one page section, page in widget section, posts in widget, posts in widgets
...
require pagesinwidgets_PATH.'general'.DIRECTORY_SEPARATOR.'init.php';
require pagesinwidgets_PATH.'widgets'.DIRECTORY_SEPARATOR.'pages-widget.php';
require pagesinwidgets_PATH.'widgets'.DIRECTORY_SEPARATOR.'posts-widget.php';