...
* Fixed Bug that caused the page/post content not to be displayed correctly 

= 1.7.1 =
Release Date: May 03, 2016

* Fixed issue that made the plugin unable to actavate or reactavate after an update
