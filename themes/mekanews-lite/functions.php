...
function mekanews_lite_infinite_scroll_init() {
    add_theme_support( 'infinite-scroll', array(
        'container' => 'content',
        'render'    => 'mekanews_lite_infinite_scroll_render',
        'footer'    => 'wrapper',
    ) );
}
add_action( 'after_setup_theme', 'mekanews_lite_infinite_scroll_init' );
