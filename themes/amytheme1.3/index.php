...
}else if($ab_amy_settings['amy-slider-hoverfx'] == 'none'){
	$as_hfx  = "none";
}else{
...
if(have_posts()){?> 
                    ...
                    <div class="layer tt-cn-style" data-depth="<?php echo $ab_amy_settings['amy-slider-parallax-depth']?>"><?php 
                        ...
                        if(function_exists( 'is_woocommerce' ) && $post_type=='product' && $ab_amy_settings['woo-thumb-style'] == 'style1'){
                            ...
                            get_template_part( 'inc/woo-style', '2' );	
							 ...
							 if($ab_amy_settings['amy-slider-hoverfx'] == 'newstyle1' || $ab_amy_settings['amy-slider-hoverfx'] == 'newstyle2' || $ab_amy_settings['amy-slider-hoverfx'] == 'newstyle3'){
                            	get_template_part( 'inc/new-def-style', '1' );	
	...
	//404 ERROR PAGE
	//=====================================================
	if(isset($ab_amy_settings['404-page']) && $ab_amy_settings['404-page'] != '' ){
		get_template_part( '404' );
	}else{?>
		<div id="mainpage" <?php post_class(); ?>>
        
			<div id='firsts' class=" scene center-content paddingtop">
