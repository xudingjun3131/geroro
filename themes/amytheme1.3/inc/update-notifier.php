...
define( 'NOTIFIER_THEME_NAME', 'AMY Theme' ); // The theme name
define( 'NOTIFIER_THEME_FOLDER_NAME', 'amytheme' ); // The theme folder name
define( 'NOTIFIER_XML_FILE', 'http://themes.cray.bg/themeupdatesnotifier/amy.xml' ); // The remote notifier XML file containing the latest version of the theme and changelog
define( 'NOTIFIER_CACHE_INTERVAL', 81600 ); // The time interval for the remote XML cache in the database (21600 seconds = 6 hours)
...
function update_notifier_menu() {  
	...
	$theme_data = $my_theme->get( 'Version' );
		if( (float)$xml->latest > (float)$theme_data) { // Compare current theme version with the remote XML version
...
function update_notifier() { 
	...
	<div class="wrap">
	    ...
	    <div id="message" class="updated below-h2"><p><strong>There is a new version of the <?php echo NOTIFIER_THEME_NAME; ?> theme available.</strong> You have version <?php echo $theme_data; ?> installed. Update to version <?php echo $xml->latest; ?>.</p></div>
