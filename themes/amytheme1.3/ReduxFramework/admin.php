...
if (!class_exists('Redux_Framework_sample_config')) {
    ...
    class Redux_Framework_sample_config {
        ...
        function dynamic_section($sections) {
            //$sections = array();
            $sections[] = array(
                'title' => __('Section via hook', 'amy-theme'),
                'desc' => __('<p class="description">This is a section created by adding a filter to the sections array. Can be used by child themes to add/remove sections from the options.</p>', 'amy-theme'),
        ...
        public function setSections() {
            ...
            $customize_title = sprintf(__('Customize &#8220;%s&#8221;', 'amy-theme'), $this->theme->display('Name'));
            ...
            <?php if ($screenshot) : ?>
                ...
                <div>
                    <ul class="theme-info">
                        <li><?php printf(__('By %s', 'amy-theme'), $this->theme->display('Author')); ?></li>
                        <li><?php printf(__('Version %s', 'amy-theme'), $this->theme->display('Version')); ?></li>
                        <li><?php echo '<strong>' . __('Tags', 'amy-theme') . ':</strong> '; ?><?php printf($this->theme->display('Tags')); ?></li>
                    </ul>
                    <p class="theme-description"><?php echo $this->theme->display('Description'); ?></p>
            <?php
            if ($this->theme->parent()) {
                printf(' <p class="howto">' . __('This <a href="%1$s">child theme</a> requires its parent theme, %2$s.') . '</p>', __('http://codex.wordpress.org/Child_Themes', 'amy-theme'), $this->theme->parent()->display('Name'));
            }
            ?>
            ...
            $this->sections[] = array(
                'title'     => __('General Settings', 'amy-theme'),
                'desc'      => __('In this section you can find general options', 'amy-theme'),
               // 'icon'      => 'el-icon-home',
				'icon'      => 'el-icon-cogs',
                ...
                'fields'    => array(
					array(
							...
							'type'      => 'info',
							'raw_html'  => true,
							'desc'      => __('<div class="rdinfotitle">Site width</div>', 'amy-theme'),
					),
					array(
                        'id'        => 'site-width',
                        'type'      => 'button_set',
                        'title'     => __('Site width', 'amy-theme'),
                        'options'   => array(
                            'boxed' => 'Boxed', 
					...
					array(
							...
							'type'      => 'info',
							'raw_html'  => true,
							'desc'      => __('<div class="rdinfotitle">Header and Footer styles</div>', 'amy-theme'),
					),
					array(
                        'id'        => 'menu-position',
                        'type'      => 'button_set',
                        'title'     => __('Menu position', 'amy-theme'),
                        'options'   => array(
                            'fixed' => 'Fixed', 
                            'absolute' => 'Absolute'
                        ),
					...
					array(
                        'id'        => 'footer-position',
                        'type'      => 'button_set',
                        'title'     => __('Footer position', 'amy-theme'),
                        'options'   => array(
                            'fixed' => 'Fixed', 
                            'absolute' => 'Absolute'
                        ),
					...
					array(
                        'id'        => 'footer-width',
                        'type'      => 'button_set',
                        'title'     => __('Footer width', 'amy-theme'),
                        'options'   => array(
                            'boxed' => 'Boxed', 
                            'fullwidth' => 'Full width'
                        ),
					...
					array(
							...
							'type'      => 'info',
							'raw_html'  => true,
							'desc'      => __('<div class="rdinfotitle">Other</div>', 'amy-theme'),
					),
					array(
                        'id'        => 'future-posts',
                        'type'      => 'switch',
                        'title'     => __('Posts in future', 'amy-theme'),
                        'subtitle'  => __('Enable this option if you want to publish posts with future date', 'amy-theme'),
                        'default'   => false,
                        'on'        => 'On',
                        'off'       => 'Off',
                    ),
					...
					array(
                        'id'                => 'disqus-id',
                        'type'              => 'text',
                        'title'             => __('Disqus ID', 'amy-theme'),
                    ),
					array(
                        'id'        => 'menu-search',
                        'type'      => 'switch',
                        'title'     => __('Menu search field', 'amy-theme'),
                        'default'   => true,
                        'on'        => 'On',
                        'off'       => 'Off',
                    ),
					array(
							...
							'type'      => 'info',
							'raw_html'  => true,
							'desc'      => __('<div class="rdinfotitle">Logo and fav ico</div>', 'amy-theme'),
					),
					array(
						'id' => 'logo-img',
						'type' => 'media',
						'title' => __('Section Logo Image', 'resumi-admin'),
						'subtitle'  => __('200x70px', 'amy-theme'),
					...
					array(
						...
						'desc'      => __('You can visit <a href="http://www.favicon.cc">www.favicon.cc</a> to generate your own favicon', 'amy-theme'),
					...
					array(
							...
							'type'      => 'info',
							'raw_html'  => true,
							'desc'      => __('<div class="rdinfotitle">Welcome message</div>', 'amy-theme'),
					),
					array(
                        'id'        => 'welcome-msg',
                        'type'      => 'switch',
                        'title'     => __('Welcome message', 'amy-theme'),
					...
					array(
                        ...
                        'title'     => __('Welcome message text', 'amy-theme'),
...
<span id="input-method">You can add your content here</span>',
					...
					array(
							...
							'type'      => 'info',
							'raw_html'  => true,
							'desc'      => __('<div class="rdinfotitle">404 page</div>', 'amy-theme'),
					),
					 array(
                        'id'        => '404-page',
                        'type'      => 'select',
                        'data'      => 'pages',
                        'title'     => __('Select 404', 'amy-theme'),
                        'subtitle'  => __('First you need to create and then select your 404 page', 'amy-theme'),
                    ),
					...
					array(
							...
							'type'      => 'info',
							'raw_html'  => true,
							'desc'      => __('<div class="rdinfotitle">Custom code</div>', 'amy-theme'),
					),
					array(
                        'id'        => 'add-custom-css',
                        'type'      => 'ace_editor',
                        'title'     => __('Custom CSS Code', 'amy-theme'),
                        'subtitle'  => __('Paste your CSS code here.', 'amy-theme'),
                        'mode'      => 'css',
                        'theme'     => 'monokai',
                        'default'   => ".yourclass{\nmargin: 0 auto;\n}"
                    ),
                    array(
                        'id'        => 'add-custom-js',
                        'type'      => 'ace_editor',
                        'title'     => __('JS Code', 'amy-theme'),
                        'subtitle'  => __('Paste your JS code here.', 'amy-theme'),
                        'mode'      => 'javascript',
                        'theme'     => 'chrome',
            ...
            $this->sections[] = array(
			 ...
			 // ACTUAL DECLARATION OF SECTIONS
            $this->sections[] = array(
                'title'     => __('Homepage Slider', 'amy-theme'),
                'desc'      => __('Homepage slider options', 'amy-theme'),
               // 'icon'      => 'el-icon-home',
				'icon'      => 'el-icon-home',
                ...
                'fields'    => array(
					array(
							...
							'type'      => 'info',
							'raw_html'  => true,
							'desc'      => __('<div class="rdinfotitle">Homepage slider styles and content</div>', 'amy-theme'),
					),
					 array(
                        'id'        => 'amy-slider-style',
                        'type'      => 'select',
                        'title'     => __('Slider style', 'amy-theme'),
					...
					array(
                        ...
                        'type'      => 'select',
                        'data'      => 'post_type',
                        'title'     => __('Slider post type', 'amy-theme'),
						'default'   => 'post'
                    ),
					 array(
                        'id'        => 'amy-slider-cat',
                        ...
                        'data'      => 'categories',
                        'multi'     => true,
                        'title'     => __('Slider categories', 'amy-theme'),
                        'subtitle'      => __('Display only selected categories', 'amy-theme'),
                    ),
					 array(
                        'id'        => 'amy-slider-color',
                        'type'      => 'button_set',
                        'title'     => __('Slider color cheme', 'amy-theme'),
                        'options'   => array(
                            '' => 'White', 
                            'as_black_style' => 'Dark'
                        ),
					...
					array(
                        ...
                        'type'      => 'button_set',
                        'title'     => __('Slider hover style', 'amy-theme'),
                        'options'   => array(
							'' => 'Triangle',
                            'squares' => 'Squares', 
                            'waves' => 'Waves',
							'newstyle1' => 'New Style 1',
							'newstyle2' => 'New Style 2',
							'newstyle3' => 'New Style 3',
							'none' => 'None'
                        ),
                        'default'   => ''
					...
					array(
                        ...
                        'type'      => 'switch',
                        'title'     => __('Slider parallax effect', 'amy-theme'),
                        'subtitle'  => __('It will increase slightly cpu usage', 'amy-theme'),
                        'default'   => true,
                        'on'        => 'On',
                        'off'       => 'Off',
                    ),
					array(
                        ...
                        'title'     => __('Slider parallax depth', 'amy-theme'),
                        'default'       => 1.5,
                        'min'           => 0,
                        'step'          => .1,
                        'max'           => 8,
					 ...
					 array(
                        ...
                        'type'      => 'spinner',
                        'title'     => __('Slider tile excerpt', 'amy-theme'),
                        'subtitle'      => __('Maximum excerpt symbols per post tile', 'amy-theme'),
                        'default'   => '150',
                        'min'       => '0',
                        'step'      => '1',
						'max'       => '20000',
					...
					array(
                        'id'        => 'order-posts',
                        'type'      => 'button_set',
                        'title'     => __('Order posts', 'amy-theme'),
                         'options'   => array(
                            '1' => 'Last added first', 
                            '2' => 'Last added last'
                        ),
                        ...
                        'title'     => __('Pagination style', 'amy-theme'),
                        'options'   => array(
                            '1' => 'Pagination', 
                            '2' => 'Infinite Scroll'
                        ),
					 ...
					 array(
                        ...
                        'type'      => 'spinner',
                        'title'     => __('Slider first tile', 'amy-theme'),
                        'subtitle'      => __('Which tile to be on focus.', 'amy-theme'),
                        'default'   => '0',
                        'min'       => '0',
                        'step'      => '1',
						'max'       => '20000',
					...
					array(
                        ...
                        'type'      => 'switch',
                        'title'     => __('Slider slideshow', 'amy-theme'),
                        'default'   => false,
                        'on'        => 'On',
                        'off'       => 'Off',
                    ),
					 array(
                        ...
                        'title'     => __('Slideshow delay in miliseconds', 'amy-theme'),
                        'default'   => '3000',
                        'min'       => '1000',
                        'step'      => '1000',
                        'max'       => '20000',
			 ...
			 // ACTUAL DECLARATION OF SECTIONS
            $this->sections[] = array(
                'title'     => __('Footer Settings', 'amy-theme'),
                'desc'      => __('Footer settings', 'amy-theme'),
               // 'icon'      => 'el-icon-home',
				'icon'      => 'el-icon-lines',
                ...
                'fields'    => array(
					array(
							...
							'type'      => 'info',
							'raw_html'  => true,
							'desc'      => __('<div class="rdinfotitle">Footer widgets</div>', 'amy-theme'),
					),
					array(
                        'id'        => 'footer-date',
                        'type'      => 'switch',
                        'title'     => __('Date widget', 'amy-theme'),
                        'default'   => true,
                        'on'        => 'On',
                        'off'       => 'Off',
                    ),
					array(
							...
							'type'      => 'info',
							'raw_html'  => true,
							'desc'      => __('<div class="rdinfotitle">Footer layout</div>', 'amy-theme'),
					),
					 array(
                        'id'        => 'footer-layout',
                        'type'      => 'image_select',
                        'title'     => __('Select layout', 'amy-theme'),
                        'subtitle'      => __('Each column responds to footer widgets (Footer widget 1, Footer widget 2 etc.)', 'amy-theme'),
					...
					array(
							...
							'type'      => 'info',
							'raw_html'  => true,
							'desc'      => __('<div class="rdinfotitle">Footer credits</div>', 'amy-theme'),
					),
					array(
                        'id'        => 'footer-text',
                        'type'      => 'editor',
                        'title'     => __('Credits', 'amy-theme'),
					...
					array(
							...
							'type'      => 'info',
							'raw_html'  => true,
							'desc'      => __('<div class="rdinfotitle">Footer social icons</div>', 'amy-theme'),
					),
					array(
                        'id'        => 'fb-link-url',
                        'type'      => 'text',
                        'title'     => __('Facebook icon url', 'amy-theme'),
						 'desc'      => __('Enter url to show the icon', 'amy-theme'),
                        'validate'  => 'url',
					...
					array(
                        'id'        => 'tw-link-url',
                        'type'      => 'text',
                        'title'     => __('Twitter icon url', 'amy-theme'),
						 'desc'      => __('Enter url to show the icon', 'amy-theme'),
                        'validate'  => 'url',
					...
					array(
                        'id'        => 'gp-link-url',
                        'type'      => 'text',
                        'title'     => __('Google+ icon url', 'amy-theme'),
						 'desc'      => __('Enter url to show the icon', 'amy-theme'),
                        'validate'  => 'url',
					...
					array(
                        'id'        => 'pi-link-url',
                        'type'      => 'text',
                        'title'     => __('Pinterest icon url', 'amy-theme'),
						 'desc'      => __('Enter url to show the icon', 'amy-theme'),
                        'validate'  => 'url',
					...
					array(
                        'id'        => 'yt-link-url',
                        'type'      => 'text',
                        'title'     => __('Youtube icon url', 'amy-theme'),
						 'desc'      => __('Enter url to show the icon', 'amy-theme'),
                        'validate'  => 'url',
                        'default'   => '',
                    )
			 ...
			 // ACTUAL DECLARATION OF SECTIONS
            $this->sections[] = array(
                'title'     => __('Background Options', 'amy-theme'),
                'desc'      => __('Add background, slideshow or videoto to your site ', 'amy-theme'),
               // 'icon'      => 'el-icon-home',
				...
				array(
							...
							'type'      => 'info',
							'raw_html'  => true,
							'desc'      => __('<div class="rdinfotitle">Full width site background</div>', 'amy-theme'),
				),
				  array(
                        'id'        => 'def-background',
                        'type'      => 'background',
                        'output'    => array('body'),
                        'title'     => __('Background', 'amy-theme'),
                        'subtitle'  => __('This settings will apply for all pages', 'amy-theme'),
					...
					array(
							...
							'type'      => 'info',
							'raw_html'  => true,
							'desc'      => __('<div class="rdinfotitle">Boxed site background</div>', 'amy-theme'),
					),
					array(
                        'id'        => 'def-background-boxed-opa',
                        'type'      => 'color_rgba',
                        'title'     => __('Boxed style background color', 'amy-theme'),
						'subtitle'      => __('You can add opacity background color', 'amy-theme'),
					...
					array(
                        ...
                        'title'     => __('Boxed style background', 'amy-theme'),
                        'subtitle'  => __('This settings will apply for all pages', 'amy-theme'),
                        'default'   => array("background-color" => '#F1F1F1'),
					...
					array(
							...
							'type'      => 'info',
							'raw_html'  => true,
							'desc'      => __('<div class="rdinfotitle">LayerSlider background</div>', 'amy-theme'),
					),
					array(
                        'id'		=> 'layerslider-bg',
                        'type'		=> 'text',
                        'title'		=> __('LayerSlider background', 'amy-theme'),
                        'desc'		=> __('Add layerslider shortcode. Example: <span style="color:#777;">[layerslider id="5"]', 'amy-theme')
                    ),
					array(
							'id'        => 'amy-divide-b4',
							'type'      => 'info',
							'raw_html'  => true,
							'desc'      => __('<div class="rdinfotitle">Video background</div>', 'amy-theme'),
					),
					
					array(
                        'id'        => 'yt-active',
                        'type'      => 'switch',
                        'title'     => __('Activate Youtube background video', 'amy-theme'),
						'subtitle'      => __('For default homepage and boxed style site', 'amy-theme'),
                        'default'   => false,
                        'on'        => 'On',
                        'off'       => 'Off',
                    ),
					array(
                        ...
                        'title'		=> __('Youtube ID', 'amy-theme'),
                        'desc'		=> __('Add only the YT video ID <span style="color:#ddd;">http://www.youtube.com/watch?v=</span><strong>WhBoR_tgXCI</strong>', 'amy-theme')
                    ),
					array(
                        'id'        => 'yt-bg-cotrols',
                        'type'      => 'switch',
						'required'  => array('yt-active', '=', true),
                        'title'     => __('Video controls', 'amy-theme'),
                        'default'   => true,
                        'on'        => 'On',
                        'off'       => 'Off',
                    ),
					...
					array(
                        ...
                        'type'      => 'button_set',
						'required'  => array('yt-active', '=', true),
                        'title'     => __('Rpeat video', 'amy-theme'),
                        'options'   => array(
							'true' => 'Rpeat',
                            'false' => 'Play once'
                        ),
					...
					array(
                        ...
                        'type'      => 'spinner',
						'required'  => array('yt-active', '=', true),
                        'title'     => __('Start video at second', 'amy-theme'),
                        'default'   => '0',
                        'min'       => '0',
                        'step'      => '1',
						'max'		=> '99999999'
					...
					array(
							...
							'type'      => 'info',
							'raw_html'  => true,
							'desc'      => __('<div class="rdinfotitle">Slideshow background</div>', 'amy-theme'),
					),
					array(
                        'id'        => 'bg-active',
                        'type'      => 'switch',
                        'title'     => __('Activate bacgkround slideshow', 'amy-theme'),
                        'default'   => false,
                        'on'        => 'On',
                        'off'       => 'Off',
                    ),
					array(
                        ...
                        'title'     => __('Vertical alignment', 'amy-theme'),
                        'options'   => array(
							'1' => 'All pages',
							'0' => 'Homepage',
                        ),
					...
					array(
                        ...
                        'type'      => 'image_select',
                     	'required'  => array('bg-active', '=', true),
                        'title'     => __('Bacgkroudn overlay', 'amy-theme'),
					...
					array(
                        ...
                        'type'      => 'spinner',
						'required'  => array('bg-active', '=', true),
                        'title'     => __('Fade out speed in miliseconds', 'amy-theme'),
                        'default'   => '1000',
                        'min'       => '1000',
                        'step'      => '1000',
                        'max'       => '10000',
					...
					array(
                        ...
                        'type'      => 'button_set',
						'required'  => array('bg-active', '=', true),
                        'title'     => __('Horizontal alignment', 'amy-theme'),
                        'options'   => array(
							'left' => 'Left',
							'center' => 'Center',
							'right' => 'Right'
					  ...
					  array(
                        ...
                        'type'      => 'slides',
						'required'  => array('bg-active', '=', true),
                        'title'     => __('Add backgroudn images', 'amy-theme'),
			 ...
			 $this->sections[] = array(
                'title'     => __('Styling Options', 'amy-theme'),
                'desc'      => __('Change fonts and colors', 'amy-theme'),
               // 'icon'      => 'el-icon-home',
                ...
                'fields'    => array(
				   array(
							...
							'type'      => 'info',
							'raw_html'  => true,
							'desc'      => __('<div class="rdinfotitle">Main color scheme</div>', 'amy-theme'),
					),
					array(
                        'id'        => 'body-color-scheme',
                        'type'      => 'image_select',
                        'title'     => __('Header and footer color scheme', 'amy-theme'),
					...
					array(
							...
							'type'      => 'info',
							'raw_html'  => true,
							'desc'      => __('<div class="rdinfotitle">Main fonts</div>', 'amy-theme'),
					),
					
					array(
                        'id'        => 'body-typography',
                        'type'      => 'typography',
                        'title'     => __('Body Font', 'amy-theme'),
                        'google'    => true,
						'font-backup'   => true,
                        'line-height'   => false,
						'text-align'	=> false,
					...
					array(
                        ...
                        'type'      => 'typography',
                        'title'     => __('Coustom font', 'amy-theme'),
                        'google'    => true,
						'font-backup'   => true,
                        'line-height'   => false,
						'text-align'	=> false,
					...
					array(
							...
							'type'      => 'info',
							'raw_html'  => true,
							'desc'      => __('<div class="rdinfotitle">Menu</div>', 'amy-theme'),
					),
				array(
                        'id'        => 'menu-background',
                        'type'      => 'color_rgba',
                        'title'     => __('Menu background color', 'amy-theme'),
					...
					array(
                        ...
                        'type'      => 'switch',
                        'title'     => __('Menu background gradient', 'amy-theme'),
                        'default'   => false,
                        'on'        => 'On',
                        'off'       => 'Off',
                    ),
					array(
                        ...
                        'title'     => __('Gradient height', 'amy-theme'),
                        'default'   => '100',
                        'min'       => '0',
                        'step'      => '1',
						'max'		=> '500'
					...
					array(
                        ...
                        'type'      => 'switch',
                        'title'     => __('Menu background shadow', 'amy-theme'),
                        'default'   => true,
                        'on'        => 'On',
                        'off'       => 'Off',
                    ),
					array(
                        'id'            => 'menu-typography',
                        'type'          => 'typography',
                        'title'         => __('Menu typography', 'amy-theme'),
                        ...
                        'output'        => array('.nav li a', '.responsivemenu  a', "#navs",'.searchmenu:after','#mainmenu .dl-menuwrapper button'), // An array of CSS selectors to apply this font style to dynamically
					...
					array(
                        ...
                        'type'      => 'info',
                        'raw_html'  => true,
                        'desc'      => __('<div class="rdinfotitle">Sub-Menu</div>', 'amy-theme'),
                    ),
					array(
                        'id'        => 'submenu-background',
                        'type'      => 'color_rgba',
                        'title'     => __('Sub-menu background color', 'amy-theme'),
					...
					array(
						...
						'left'      => false,
						'color'		=> false,
                        'title'     => __('Sub-menu borders', 'amy-theme'),
					...
					array(
                        ...
                        'type'      => 'color_rgba',
                        'title'     => __('Sub-menu borders color', 'amy-theme'),
					...
					array(
                        ...
                        'type'          => 'typography',
                        'title'         => __('Sub-menu typography', 'amy-theme'),
                        'google'        => true,
                        'font-backup'   => true, 
                        'line-height'   => false,
						'text-align'	=> false,
					...
					array(
                        ...
                        'type'      => 'info',
                        'raw_html'  => true,
                        'desc'      => __('<div class="rdinfotitle">Widgets</div>', 'amy-theme'),
                    ),
					array(
                        'id'        => 'widget-typography',
                        'type'      => 'typography',
                        'title'     => __('Widget titles', 'amy-theme'),
                        'subtitle'  => __('Specify the body font properties.', 'amy-theme'),
                        'google'    => true,
						'font-backup'   => true,
                        'line-height'   => false,
						'text-align'	=> false,
					...
					array(
						...
						'left'      => false,
						'color'      => false,
                        'title'     => __('Widgets bottom borders', 'amy-theme'),
					...
					array(
                        ...
                        'type'      => 'color_rgba',
                        'title'     => __('Widgets bottom borders color', 'amy-theme'),
					...
					array(
                        ...
                        'type'      => 'info',
                        'raw_html'  => true,
                        'desc'      => __('<div class="rdinfotitle">Default page padding</div>', 'amy-theme'),
                    ),
					 array(
                        'id'            => 'page-spacing',
                        'type'          => 'spacing',
                        ...
                        'title'         => __('Page padding', 'amy-theme'),
                        'subtitle'      => __('Add top and bottom padding to all pages.', 'amy-theme'),
					...
					array(
                        ...
                        'type'      => 'info',
                        'raw_html'  => true,
                        'desc'      => __('<div class="rdinfotitle">Comments background</div>', 'amy-theme'),
                    ),
					 array(
                        'id'        => 'commnets-background',
                        'type'      => 'color_rgba',
                        'title'     => __('Background color', 'amy-theme'),
					...
					array(
                        ...
                        'type'      => 'info',
                        'raw_html'  => true,
                        'desc'      => __('<div class="rdinfotitle">Input fields</div>', 'amy-theme'),
                    ),
					 array(
                        'id'        => 'input-filed-background',
                        'type'      => 'color_rgba',
                        'title'     => __('Input fields background color', 'amy-theme'),
                        'default'   => array('color' => '#f9f9f9', 'alpha' => '1.0'),
					...
					array(
						...
						'all'      => true,
						'color'		=>false,
                        'title'     => __('Input fields border', 'amy-theme'),
					...
					array(
                        'id'        => 'input-text-color',
                        'type'      => 'color_rgba',
                        'title'     => __('Input fields color', 'amy-theme'),
					...
					array(
                        ...
                        'type'      => 'color_rgba',
                        'title'     => __('Input fields border color', 'amy-theme'),
					...
					array(
                        ...
                        'type'      => 'info',
                        'raw_html'  => true,
                        'desc'      => __('<div class="rdinfotitle">Footer</div>', 'amy-theme'),
                    ),
					array(
                        'id'        => 'path-background',
                        'type'      => 'color_rgba',
                        'title'     => __('Footer sitepath background color', 'amy-theme'),
					...
					array(
                        ...
                        'type'      => 'color_rgba',
                        'title'     => __('Footer background color', 'amy-theme'),
					...
					array(
                        ...
                        'type'      => 'typography',
                        'title'     => __('Footer text color', 'amy-theme'),
                        'google'    => false,
						'font-backup'   => false,
                        'line-height'   => false,
						'text-align'	=> false,
					...
					array(
                        ...
                        'type'      => 'color_rgba',
                        'title'     => __('Footer widget area background color', 'amy-theme'),
					...
					array(
						...
						'top'      => false,
						'left'      => false,
                        'title'     => __('Footer widgets bottom borders', 'amy-theme'),
					...
					array(
                        ...
                        'type'      => 'typography',
                        'title'     => __('Footer typography', 'amy-theme'),
                        'google'    => true,
						'font-backup'   => true,
                        'line-height'   => false,
						'text-align'	=> false,
					...
					array(
                        ...
                        'type'      => 'info',
                        'raw_html'  => true,
                        'desc'      => __('<div class="rdinfotitle">Loading bacground color</div>', 'amy-theme'),
                    ),
					array(
                        'id'        => 'loading-bacground',
                        'type'      => 'color_rgba',
                        'title'     => __('Color', 'amy-theme'),
					...
					array(
                        ...
                        'type'      => 'info',
                        'raw_html'  => true,
                        'desc'      => __('<div class="rdinfotitle">Big images bacground color</div>', 'amy-theme'),
                    ),
					array(
                        'id'        => 'img-bacground',
                        'type'      => 'color_rgba',
					...
					array(
                        ...
                        'type'      => 'info',
                        'raw_html'  => true,
                        'desc'      => __('<div class="rdinfotitle">WooCommerce messages</div>', 'amy-theme'),
                    ),
					array(
                        'id'        => 'woo-errmsg-bg',
                        'type'      => 'color_rgba',
                        'title'     => __('Messages backround color', 'amy-theme'),
                        'default'   => array('color' => '#f9f9f9', 'alpha' => '1.0'),
					...
					array(
                        'id'        => 'woo-errmsg-text',
                        'type'      => 'color_rgba',
                        'title'     => __('Messages text color', 'amy-theme'),
                        'default'   => array('color' => '#777777', 'alpha' => '1.0'),
                        'output'    => array('.woocommerce .woocommerce-error','.woocommerce .woocommerce-message', '.woocommerce .woocommerce-info'),
                        'mode'      => 'color',
                        'validate'  => 'colorrgba',
					...
					array(
                        ...
                        'type'      => 'info',
                        'raw_html'  => true,
                        'desc'      => __('<div class="rdinfotitle">WooCommerce input fields</div>', 'amy-theme'),
                    ),
					 array(
                        'id'        => 'woo-input-bg',
                        'type'      => 'color_rgba',
					...
					array(
                        ...
                        'type'      => 'color_rgba',
                        'title'     => __('Forms border color', 'amy-theme'),
                        'default'   => array('color' => '#ececec', 'alpha' => '1.0'),
			 ...
			 $this->sections[] = array(
                'title'     => __('Translation', 'amy-theme'),
               // 'icon'      => 'el-icon-home',
				'icon'      => 'el-icon-globe',
                ...
                'fields'    => array(
					...
					array(
                        ...
                        'type'              => 'text',
                        'title'             => __('Responsive menu button label', 'amy-theme'),
						'default'   => 'Menu'
                    ),
					array(
                        'id'                => 'tr-resmenu-title',
                        'type'              => 'text',
                        'title'             => __('Responsive menu header', 'amy-theme'),
						'default'   => 'Menu'
                    ),
					array(
                        'id'                => 'tr-menu-search',
                        'type'              => 'text',
                        'title'             => __('Search placeholder', 'amy-theme'),
						'default'   => 'Search...'
                    ),
					array(
                        'id'        => 'amy-divide-t4',
                        'type'      => 'info',
                        'raw_html'  => true,
                        'desc'      => __('<div class="rdinfotitle">Footer post counter</div>', 'amy-theme'),
                    ),
					array(
                        'id'                => 'tr-footer-home-info',
                        'type'              => 'text',
                        'title'             => __('For homepage', 'amy-theme'),
						'default'   => 'posts<br>at home page'
                    ),
					array(
                        'id'                => 'tr-footer-search-info',
                        'type'              => 'text',
                        'title'             => __('For search', 'amy-theme'),
						'default'   => 'results<br>found'
                    ),
					array(
                        'id'                => 'tr-footer-archive-info',
                        'type'              => 'text',
                        'title'             => __('For archive', 'amy-theme'),
						'default'   => 'posts<br>in archive'
                    ),
					array(
                        'id'                => 'tr-footer-category-info',
                        'type'              => 'text',
                        'title'             => __('For category', 'amy-theme'),
						'default'   => 'posts<br>in '
                    ),
					array(
                        'id'        => 'amy-divide-t5',
                        'type'      => 'info',
                        'raw_html'  => true,
                        'desc'      => __('<div class="rdinfotitle">WordPress comments</div>', 'amy-theme'),
                    ),
					array(
                        'id'                => 'tr-comm-name',
                        'type'              => 'text',
                        'title'             => __('Name label', 'amy-theme'),
						'default'   => 'Name'
                    ),
					array(
                        'id'                => 'tr-comm-email',
                        'type'              => 'text',
                        'title'             => __('E-mail label', 'amy-theme'),
						'default'   => 'E-mail'
                    ),
					array(
                        'id'                => 'tr-comm-comment',
                        'type'              => 'text',
                        'title'             => __('Comment label', 'amy-theme'),
						'default'   => 'Comment'
                    ),
					...
					array(
                        'id'                => 'tr-comm-title',
                        'type'              => 'text',
                        'title'             => __('Leave a reply title', 'amy-theme'),
						'default'   => 'Leave a Reply'
                    ),
					array(
                        'id'                => 'tr-comm-subtitle',
                        'type'              => 'text',
                        'title'             => __('Leave a reply subtitle', 'amy-theme'),
						'default'   => 'Your email address will not be published.'
                    ),
					array(
                        'id'                => 'tr-comm-submit',
                        'type'              => 'text',
                        'title'             => __('Submit button label', 'amy-theme'),
					...
					array(
                        'id'                => 'tr-comm-newcomm',
                        'type'              => 'text',
                        'title'             => __('Newer comments button label', 'amy-theme'),
						'default'   => 'Newer Comments &rarr;'
                    ),
					array(
                        'id'                => 'tr-comm-oldcomm',
                        'type'              => 'text',
                        'title'             => __('Older comments button label', 'amy-theme'),
					...
					array(
                        ...
                        'type'              => 'text',
                        'title'             => __('Reply comment button label', 'amy-theme'),
						'default'   => 'Reply'
                    ),
					array(
                        'id'                => 'tr-comm-mustlogin',
                        'type'              => 'text',
                        'title'             => __('You must be logged in label', 'amy-theme'),
					...
					array(
                        'id'                => 'tr-comm-login',
                        'type'              => 'text',
                        'title'             => __('Log in label', 'amy-theme'),
						'default'   => 'Log in?'
                    ),
					array(
                        'id'                => 'tr-comm-logout',
                        'type'              => 'text',
                        'title'             => __('Log out label', 'amy-theme'),
						'default'   => 'Log out?'
                    ),
					array(
                        'id'                => 'tr-comm-loggedin',
                        'type'              => 'text',
                        'title'             => __('Logged in label', 'amy-theme'),
					...
					array(
                        'id'                => 'tr-comm-1comm',
                        'type'              => 'text',
                        'title'             => __('Single comment', 'amy-theme'),
						'default'   => 'thought on'
                    ),
					array(
                        'id'                => 'tr-comm-2comm',
                        'type'              => 'text',
                        'title'             => __('More then 1 comment', 'amy-theme'),
						'default'   => 'thoughts on'
                    ),
					array(
                        'id'        => 'amy-divide-t6',
                        'type'      => 'info',
                        'raw_html'  => true,
                        'desc'      => __('<div class="rdinfotitle">Other comments</div>', 'amy-theme'),
                    ),
					array(
                        'id'                => 'tr-disqus-title',
                        'type'              => 'text',
                        'title'             => __('Disqus comments title', 'amy-theme'),
						'default'   => 'Disqus comments'
                    ),
					array(
                        'id'                => 'tr-facebook-title',
                        'type'              => 'text',
                        'title'             => __('Facebook comments title', 'amy-theme'),
					...
					array(
                        ...
                        'type'      => 'info',
                        'raw_html'  => true,
                        'desc'      => __('<div class="rdinfotitle">Woocommerce elements</div>', 'amy-theme'),
                    ),
					
					array(
                        'id'                => 'tr-woo-cart-title',
                        'type'              => 'text',
                        'title'             => __('Footer cart title', 'amy-theme'),
						'default'   => 'Cart'
                    ),
					array(
                        'id'                => 'tr-woo-1cart',
                        'type'              => 'text',
                        'title'             => __('Footer cart 1 item', 'amy-theme'),
						'default'   => 'item'
                    ),
					array(
                        'id'                => 'tr-woo-2cart',
                        'type'              => 'text',
                        'title'             => __('Footer cart more then 1 item', 'amy-theme'),
						'default'   => 'items'
                    ),
					...
					array(
                        ...
                        'type'      => 'info',
                        'raw_html'  => true,
                        'desc'      => __('<div class="rdinfotitle">Footer clock months</div>', 'amy-theme'),
                    ),
					array(
                        'id'                => 'tr-months-jan',
                        'type'              => 'text',
                        'title'             => __('January', 'amy-theme'),
						'default'   => 'January'
                    ),
					array(
                        'id'                => 'tr-months-feb',
                        'type'              => 'text',
                        'title'             => __('February', 'amy-theme'),
						'default'   => 'February'
                    ),
					array(
                        'id'                => 'tr-months-mar',
                        'type'              => 'text',
                        'title'             => __('March', 'amy-theme'),
						'default'   => 'March'
                    ),
					array(
                        'id'                => 'tr-months-apr',
                        'type'              => 'text',
                        'title'             => __('April', 'amy-theme'),
						'default'   => 'April'
                    ),
					array(
                        'id'                => 'tr-months-may',
                        'type'              => 'text',
                        'title'             => __('May', 'amy-theme'),
						'default'   => 'May'
                    ),
					array(
                        'id'                => 'tr-months-jun',
                        'type'              => 'text',
                        'title'             => __('June', 'amy-theme'),
						'default'   => 'June'
                    ),
					array(
                        'id'                => 'tr-months-jul',
                        'type'              => 'text',
                        'title'             => __('July', 'amy-theme'),
						'default'   => 'July'
                    ),
					array(
                        'id'                => 'tr-months-aug',
                        'type'              => 'text',
                        'title'             => __('August', 'amy-theme'),
						'default'   => 'August'
                    ),
					array(
                        'id'                => 'tr-months-sep',
                        'type'              => 'text',
                        'title'             => __('September', 'amy-theme'),
						'default'   => 'September'
                    ),
					array(
                        'id'                => 'tr-months-oct',
                        'type'              => 'text',
                        'title'             => __('October', 'amy-theme'),
						'default'   => 'October'
                    ),
					array(
                        'id'                => 'tr-months-nov',
                        'type'              => 'text',
                        'title'             => __('November', 'amy-theme'),
						'default'   => 'November'
                    ),
					array(
                        'id'                => 'tr-months-dec',
                        'type'              => 'text',
                        'title'             => __('December', 'amy-theme'),
						'default'   => 'December'
                    ),
					array(
                        'id'        => 'amy-divide-t1',
					...
					array(
                        'id'                => 'tr-slider-readmore',
                        'type'              => 'text',
                        'title'             => __('Slider read more link', 'amy-theme'),
						'default'   => 'Read more'
                    ),
					array(
                        'id'                => 'tr-nav-tooltip',
                        'type'              => 'text',
                        'title'             => __('Footer navigation arrows', 'amy-theme'),
			 ...
			 $this->sections[] = array(
                'title'     => __('WooCommerce', 'amy-theme'),
               // 'icon'      => 'el-icon-home',
                ...
                'fields'    => array(
					array(
                        'id'        => 'woo-def-color',
                        'type'      => 'button_set',
                        'title'     => __('Woocommerce color cheme', 'amy-theme'),
                        'options'   => array(
                            '' => 'White', 
                            'as_black_style' => 'Dark'
                        ),
					...
					array(
                        'id'        => 'woo-def-rows',
                        'type'      => 'spinner',
                        'title'     => __('Default woocommerce grid rows', 'amy-theme'),
                        'default'   => '3',
                        'min'       => '2',
                        'step'      => '1',
						'max'       => '3',
					...
					array(
					 ...
					 array(
                        'id'        => 'woo-thumb-style',
                        'type'      => 'button_set',
                        'title'     => __('Woo thumb style', 'amy-theme'),
						 //Must provide key => value pairs for select options
                        'options'   => array(
                            'style1' => 'Style 1', 
                            'style2' => 'Style 2'
					...
					array(
                        'id'        => 'woo-footer-cart',
                        'type'      => 'switch',
                        'title'     => __('Show footer cart', 'amy-theme'),
                        'default'   => true,
                        'on'        => 'On',
                        'off'       => 'Off',
                    ),
			...
			$this->sections[] = array(
                'title'     => __('One click styles', 'amy-theme'),
               // 'icon'      => 'el-icon-home',
				'icon'      => 'el-icon-magic',
                'fields'    => array(
					   ...
					   array(
                        ...
                        'type'      => 'image_select',
                        'presets'   => true,
                        'title'     => __('Select theme style', 'amy-theme'),
                        'subtitle'  => __('You can customize each settings after selecting your theme style', 'amy-theme'),
                        'default'   => 0,
                        'options'   => array(
...
{"last_tab":"","site-width":"fullwidth","menu-position":"fixed","menu-width":"fullwidth","footer-position":"absolute","footer-width":"fullwidth","future-posts":"","disqus-id":"andreyboyadzhiev","menu-search":"1","logo-img":{"url":"'.get_template_directory_uri().'/images/logo.png","id":"","height":"70","width":"200","thumbnail":"'.get_template_directory_uri().'/images/logo.png"},"fav-ico":{"url":"'.get_template_directory_uri().'/images/favicon.ico","id":"","height":"","width":"","thumbnail":""},"welcome-msg":"1","welcome-msg-text":"<span class=\"content-title\">Welcome<\/span>\r\n<span id=\"input-method\">You can add your content here<\/span>","404-page":"","add-custom-css":"                .yourclass{\r\nmargin: 0 auto;\r\n}            ","add-custom-js":"                jQuery(document).ready(function(){\r\n\r\n});            ","amy-slider-style":"classic","amy-slider-post-type":"post","amy-slider-color":"as_black_style","amy-slider-hoverfx":"","amy-slider-parallax":"0","amy-slider-parallax-depth":"1.5","amy-slider-excerpt":"150","order-posts":"1","def-pagination-display":"2","amy-slider-first-post":"4","amy-slider-autorotate":"","amy-slider-autorotate-delay":"3000","footer-date":"1","footer-layout":"5","footer-text":"<strong>Copyright 2014 <\/strong>\r\nDesigned by <a href=\"http:\/\/yoursite.com\">Your Name<\/a>","fb-link-url":"https:\/\/facebook.com","tw-link-url":"https:\/\/twitter.com","gp-link-url":"https:\/\/plus.google.com\/","pi-link-url":"https:\/\/www.pinterest.com\/","yt-link-url":"","def-background":{"background-color":"#3f3f3f","background-repeat":"","background-size":"","background-attachment":"","background-position":"","background-image":"","media":{"id":"","height":"","width":"","thumbnail":""}},"def-background-boxed-opa":{"color":"#000000","alpha":"0.43"},"def-background-boxed":{"background-repeat":"","background-size":"","background-attachment":"","background-position":"","background-image":"","media":{"id":"","height":"","width":"","thumbnail":""}},"layerslider-bg":"","yt-active":"0","yt-bg-id":"piH5_aP0fY8","yt-bg-cotrols":"1","yt-bg-mute":"false","yt-bg-repeat":"true","yt-bg-start":"0","bg-active":"1","bg-allpages":"0","bg-overlays":"16","bg-delay":"6000","bg-fade":"1000","bg-vposition":"center","bg-hposition":"center","bg-slides":[{"title":"","description":"","url":"","sort":"0","attachment_id":"","thumb":"'.get_template_directory_uri().'/images/defbg-black-150.jpg","image":"'.get_template_directory_uri().'/images/defbg-black.jpg","height":"1280","width":"1920"}],"body-color-scheme":"peterriver","body-typography":{"font-family":"Open Sans","font-options":"{\"variants\":[{\"id\":\"300\",\"name\":\"Book+300\"},{\"id\":\"400\",\"name\":\"Normal+400\"},{\"id\":\"600\",\"name\":\"Semi-Bold+600\"},{\"id\":\"700\",\"name\":\"Bold+700\"},{\"id\":\"800\",\"name\":\"Extra-Bold+800\"},{\"id\":\"300italic\",\"name\":\"Book+300+Italic\"},{\"id\":\"400italic\",\"name\":\"Normal+400+Italic\"},{\"id\":\"600italic\",\"name\":\"Semi-Bold+600+Italic\"},{\"id\":\"700italic\",\"name\":\"Bold+700+Italic\"},{\"id\":\"800italic\",\"name\":\"Extra-Bold+800+Italic\"}],\"subsets\":[{\"id\":\"devanagari\",\"name\":\"Devanagari\"},{\"id\":\"cyrillic\",\"name\":\"Cyrillic\"},{\"id\":\"latin\",\"name\":\"Latin\"},{\"id\":\"latin-ext\",\"name\":\"Latin+Extended\"},{\"id\":\"cyrillic-ext\",\"name\":\"Cyrillic+Extended\"},{\"id\":\"greek\",\"name\":\"Greek\"},{\"id\":\"vietnamese\",\"name\":\"Vietnamese\"},{\"id\":\"greek-ext\",\"name\":\"Greek+Extended\"}]}","google":"true","font-backup":"","font-weight":"400","font-style":"","subsets":"","font-size":"12px","color":"#dddddd"},"headings-typography":{"font-family":"Open Sans","font-options":"{\"variants\":[{\"id\":\"300\",\"name\":\"Book+300\"},{\"id\":\"400\",\"name\":\"Normal+400\"},{\"id\":\"600\",\"name\":\"Semi-Bold+600\"},{\"id\":\"700\",\"name\":\"Bold+700\"},{\"id\":\"800\",\"name\":\"Extra-Bold+800\"},{\"id\":\"300italic\",\"name\":\"Book+300+Italic\"},{\"id\":\"400italic\",\"name\":\"Normal+400+Italic\"},{\"id\":\"600italic\",\"name\":\"Semi-Bold+600+Italic\"},{\"id\":\"700italic\",\"name\":\"Bold+700+Italic\"},{\"id\":\"800italic\",\"name\":\"Extra-Bold+800+Italic\"}],\"subsets\":[{\"id\":\"devanagari\",\"name\":\"Devanagari\"},{\"id\":\"cyrillic\",\"name\":\"Cyrillic\"},{\"id\":\"latin\",\"name\":\"Latin\"},{\"id\":\"latin-ext\",\"name\":\"Latin+Extended\"},{\"id\":\"cyrillic-ext\",\"name\":\"Cyrillic+Extended\"},{\"id\":\"greek\",\"name\":\"Greek\"},{\"id\":\"vietnamese\",\"name\":\"Vietnamese\"},{\"id\":\"greek-ext\",\"name\":\"Greek+Extended\"}]}","google":"true","font-backup":"","font-weight":"300","font-style":"","subsets":""},"titles-typography":{"font-family":"Open Sans","font-options":"{\"variants\":[{\"id\":\"300\",\"name\":\"Book+300\"},{\"id\":\"400\",\"name\":\"Normal+400\"},{\"id\":\"600\",\"name\":\"Semi-Bold+600\"},{\"id\":\"700\",\"name\":\"Bold+700\"},{\"id\":\"800\",\"name\":\"Extra-Bold+800\"},{\"id\":\"300italic\",\"name\":\"Book+300+Italic\"},{\"id\":\"400italic\",\"name\":\"Normal+400+Italic\"},{\"id\":\"600italic\",\"name\":\"Semi-Bold+600+Italic\"},{\"id\":\"700italic\",\"name\":\"Bold+700+Italic\"},{\"id\":\"800italic\",\"name\":\"Extra-Bold+800+Italic\"}],\"subsets\":[{\"id\":\"devanagari\",\"name\":\"Devanagari\"},{\"id\":\"cyrillic\",\"name\":\"Cyrillic\"},{\"id\":\"latin\",\"name\":\"Latin\"},{\"id\":\"latin-ext\",\"name\":\"Latin+Extended\"},{\"id\":\"cyrillic-ext\",\"name\":\"Cyrillic+Extended\"},{\"id\":\"greek\",\"name\":\"Greek\"},{\"id\":\"vietnamese\",\"name\":\"Vietnamese\"},{\"id\":\"greek-ext\",\"name\":\"Greek+Extended\"}]}","google":"true","font-backup":"","font-weight":"300","font-style":"","subsets":""},"menu-background":{"color":"#000000","alpha":"0.46"},"menu-background-shadow":"1","menu-typography":{"font-family":"Open Sans","font-options":"{\"variants\":[{\"id\":\"300\",\"name\":\"Book+300\"},{\"id\":\"400\",\"name\":\"Normal+400\"},{\"id\":\"600\",\"name\":\"Semi-Bold+600\"},{\"id\":\"700\",\"name\":\"Bold+700\"},{\"id\":\"800\",\"name\":\"Extra-Bold+800\"},{\"id\":\"300italic\",\"name\":\"Book+300+Italic\"},{\"id\":\"400italic\",\"name\":\"Normal+400+Italic\"},{\"id\":\"600italic\",\"name\":\"Semi-Bold+600+Italic\"},{\"id\":\"700italic\",\"name\":\"Bold+700+Italic\"},{\"id\":\"800italic\",\"name\":\"Extra-Bold+800+Italic\"}],\"subsets\":[{\"id\":\"devanagari\",\"name\":\"Devanagari\"},{\"id\":\"cyrillic\",\"name\":\"Cyrillic\"},{\"id\":\"latin\",\"name\":\"Latin\"},{\"id\":\"latin-ext\",\"name\":\"Latin+Extended\"},{\"id\":\"cyrillic-ext\",\"name\":\"Cyrillic+Extended\"},{\"id\":\"greek\",\"name\":\"Greek\"},{\"id\":\"vietnamese\",\"name\":\"Vietnamese\"},{\"id\":\"greek-ext\",\"name\":\"Greek+Extended\"}]}","google":"true","font-backup":"","font-weight":"300","font-style":"","subsets":"","font-size":"13px","line-height":"18px","color":"#dddddd"},"submenu-background":{"color":"#050505","alpha":"0.80"},"submenu-border":{"border-top":"0","border-right":"0","border-bottom":"1px","border-left":"0","border-style":"solid"},"submenu-border-color":{"color":"#333333","alpha":"0.06"},"submenu-typography":{"font-family":"Open Sans","font-options":"{\"variants\":[{\"id\":\"300\",\"name\":\"Book+300\"},{\"id\":\"400\",\"name\":\"Normal+400\"},{\"id\":\"600\",\"name\":\"Semi-Bold+600\"},{\"id\":\"700\",\"name\":\"Bold+700\"},{\"id\":\"800\",\"name\":\"Extra-Bold+800\"},{\"id\":\"300italic\",\"name\":\"Book+300+Italic\"},{\"id\":\"400italic\",\"name\":\"Normal+400+Italic\"},{\"id\":\"600italic\",\"name\":\"Semi-Bold+600+Italic\"},{\"id\":\"700italic\",\"name\":\"Bold+700+Italic\"},{\"id\":\"800italic\",\"name\":\"Extra-Bold+800+Italic\"}],\"subsets\":[{\"id\":\"devanagari\",\"name\":\"Devanagari\"},{\"id\":\"cyrillic\",\"name\":\"Cyrillic\"},{\"id\":\"latin\",\"name\":\"Latin\"},{\"id\":\"latin-ext\",\"name\":\"Latin+Extended\"},{\"id\":\"cyrillic-ext\",\"name\":\"Cyrillic+Extended\"},{\"id\":\"greek\",\"name\":\"Greek\"},{\"id\":\"vietnamese\",\"name\":\"Vietnamese\"},{\"id\":\"greek-ext\",\"name\":\"Greek+Extended\"}]}","google":"true","font-backup":"","font-weight":"300","font-style":"","subsets":"","font-size":"11px","color":"#dddddd"},"widget-typography":{"font-family":"Open Sans","font-options":"{\"variants\":[{\"id\":\"300\",\"name\":\"Book+300\"},{\"id\":\"400\",\"name\":\"Normal+400\"},{\"id\":\"600\",\"name\":\"Semi-Bold+600\"},{\"id\":\"700\",\"name\":\"Bold+700\"},{\"id\":\"800\",\"name\":\"Extra-Bold+800\"},{\"id\":\"300italic\",\"name\":\"Book+300+Italic\"},{\"id\":\"400italic\",\"name\":\"Normal+400+Italic\"},{\"id\":\"600italic\",\"name\":\"Semi-Bold+600+Italic\"},{\"id\":\"700italic\",\"name\":\"Bold+700+Italic\"},{\"id\":\"800italic\",\"name\":\"Extra-Bold+800+Italic\"}],\"subsets\":[{\"id\":\"devanagari\",\"name\":\"Devanagari\"},{\"id\":\"cyrillic\",\"name\":\"Cyrillic\"},{\"id\":\"latin\",\"name\":\"Latin\"},{\"id\":\"latin-ext\",\"name\":\"Latin+Extended\"},{\"id\":\"cyrillic-ext\",\"name\":\"Cyrillic+Extended\"},{\"id\":\"greek\",\"name\":\"Greek\"},{\"id\":\"vietnamese\",\"name\":\"Vietnamese\"},{\"id\":\"greek-ext\",\"name\":\"Greek+Extended\"}]}","google":"true","font-backup":"","font-weight":"400","font-style":"","subsets":"","font-size":"18px"},"widget-border":{"border-top":"0","border-right":"0","border-bottom":"1px","border-left":"0","border-style":"solid"},"widget-border-color":{"color":"#8f8f8f","alpha":"0.36"},"page-spacing":{"margin-top":"60px","margin-bottom":"60px"},"commnets-background":{"color":"#0a0a0a","alpha":"0.33"},"input-filed-background":{"color":"#0a0a0a","alpha":"0.25"},"input-filed-border":{"border-top":"1px","border-right":"1px","border-bottom":"1px","border-left":"1px","border-style":"solid"},"input-border-color":{"color":"#8f8f8f","alpha":"0.50"},"path-background":{"color":"#000000","alpha":"0.33"},"footer-background":{"color":"#1a1a1a","alpha":"0.81"},"footer-background-text":{"font-weight":"","font-style":"","color":"#a3a3a3"},"footer-background-widget":{"color":"#282828","alpha":"0.73"},"footer-widget-border":{"border-top":"0","border-right":"0","border-bottom":"1px","border-left":"0","border-style":"solid","border-color":"#4f4f4f"},"footer-typography":{"font-family":"Open Sans","font-options":"{\"variants\":[{\"id\":\"300\",\"name\":\"Book+300\"},{\"id\":\"400\",\"name\":\"Normal+400\"},{\"id\":\"600\",\"name\":\"Semi-Bold+600\"},{\"id\":\"700\",\"name\":\"Bold+700\"},{\"id\":\"800\",\"name\":\"Extra-Bold+800\"},{\"id\":\"300italic\",\"name\":\"Book+300+Italic\"},{\"id\":\"400italic\",\"name\":\"Normal+400+Italic\"},{\"id\":\"600italic\",\"name\":\"Semi-Bold+600+Italic\"},{\"id\":\"700italic\",\"name\":\"Bold+700+Italic\"},{\"id\":\"800italic\",\"name\":\"Extra-Bold+800+Italic\"}],\"subsets\":[{\"id\":\"devanagari\",\"name\":\"Devanagari\"},{\"id\":\"cyrillic\",\"name\":\"Cyrillic\"},{\"id\":\"latin\",\"name\":\"Latin\"},{\"id\":\"latin-ext\",\"name\":\"Latin+Extended\"},{\"id\":\"cyrillic-ext\",\"name\":\"Cyrillic+Extended\"},{\"id\":\"greek\",\"name\":\"Greek\"},{\"id\":\"vietnamese\",\"name\":\"Vietnamese\"},{\"id\":\"greek-ext\",\"name\":\"Greek+Extended\"}]}","google":"true","font-backup":"","font-weight":"400","font-style":"","subsets":"","font-size":"12px","color":"#a9a9a9"},"loading-bacground":{"color":"#3d3d3d","alpha":"1"},"woo-errmsg-bg":{"color":"#0a0a0a","alpha":"0.34"},"woo-errmsg-text":{"color":"#dddddd","alpha":"1.00"},"woo-input-bg":{"color":"#0a0a0a","alpha":"0.29"},"woo-input-border":{"border-top":"1px","border-right":"1px","border-bottom":"1px","border-left":"1px","border-style":"solid"},"woo-input-border-color":{"color":"#8f8f8f","alpha":"0.34"},"woo-input-color":{"color":"#dddddd","alpha":"1.00"},"woo-element-border":{"color":"#8f8f8f","alpha":"0.37"},"tr-resmenu-button":"Menu","tr-resmenu-title":"Menu","tr-menu-search":"Search...","tr-footer-home-info":"posts<br>at home page","tr-footer-search-info":"results<br>found","tr-footer-archive-info":"posts<br>in archive","tr-footer-category-info":"posts<br>in ","tr-comm-name":"Name","tr-comm-email":"E-mail","tr-comm-comment":"Comment","tr-comm-title":"Leave a Reply","tr-comm-subtitle":"Your email address will not be published.","tr-comm-submit":"Post Comment","tr-comm-newcomm":"Newer Comments \u2192","tr-comm-oldcomm":"\u2190 Older Comments","tr-comm-commreply":"Reply","tr-comm-mustlogin":"You must be logged to post a comment.","tr-comm-login":"Log in?","tr-comm-logout":"Log out?","tr-comm-loggedin":"Logged in as","tr-comm-error":"You might have left one of the fields blank, or be posting too quickly","tr-comm-thanks":"Thanks for your comment. We appreciate your response.","tr-comm-process":"Sending...","tr-comm-1comm":"thought on","tr-comm-2comm":"thoughts on","tr-disqus-title":"Disqus comments","tr-facebook-title":"Facebook comments","tr-woo-cart-title":"Cart","tr-woo-1cart":"item","tr-woo-2cart":"items","tr-months-jan":"January","tr-months-feb":"February","tr-months-mar":"March","tr-months-apr":"April","tr-months-may":"May","tr-months-jun":"June","tr-months-jul":"July","tr-months-aug":"August","tr-months-sep":"September","tr-months-oct":"October","tr-months-nov":"November","tr-months-dec":"December","tr-nav-tooltip":"Slider navigation","woo-def-color":"as_black_style","woo-def-rows":"3","woo-hoverfx":"","woo-thumb-style":"style1","woo-footer-cart":"1","REDUX_last_saved":1403298104,"amy-menu-styles":0,"amy-menu-styles2":0,"redux-backup":"1"}'),
            ...
            $theme_info .= '<p class="redux-framework-theme-data description theme-uri">' . __('<strong>Theme URL:</strong> ', 'amy-theme') . '<a href="' . $this->theme->get('ThemeURI') . '" target="_blank">' . $this->theme->get('ThemeURI') . '</a></p>';
            $theme_info .= '<p class="redux-framework-theme-data description theme-author">' . __('<strong>Author:</strong> ', 'amy-theme') . $this->theme->get('Author') . '</p>';
            $theme_info .= '<p class="redux-framework-theme-data description theme-version">' . __('<strong>Version:</strong> ', 'amy-theme') . $this->theme->get('Version') . '</p>';
            $theme_info .= '<p class="redux-framework-theme-data description theme-description">' . $this->theme->get('Description') . '</p>';
            $tabs = $this->theme->get('Tags');
            if (!empty($tabs)) {
                $theme_info .= '<p class="redux-framework-theme-data description theme-tags">' . __('<strong>Tags:</strong> ', 'amy-theme') . implode(', ', $tabs) . '</p>';
            }
            $theme_info .= '</div>';
            ...
            if (file_exists(dirname(__FILE__) . '/../README.md')) {
                $this->sections['theme_docs'] = array(
                    ...
                    'title'     => __('Documentation', 'amy-theme'),
                    'fields'    => array(
                        array(
                            'id'        => '17',
                            'type'      => 'raw',
            ...
            $this->sections[] = array(
                'title'     => __('Import / Export', 'amy-theme'),
                'desc'      => __('Import and Export your Redux Framework settings from file, text or URL.', 'amy-theme'),
			...
			$this->sections[] = array(
                ...
                'title'     => __('Support', 'amy-theme'),
                'fields'    => array(
                    array(
                        'id'        => 'opt-raw-info',
                        'type'      => 'raw',
                        'content'   => '<iframe src="http://themes.cray.bg/rd/support.html" sandbox="allow-forms allow-scripts" width="100%" height="800px" style="min-width:800px;"></iframe>',
                    )
                ),
            );
            ...
            $this->sections[] = array(
                'icon'      => 'el-icon-info-sign',
                'title'     => __('Theme Information', 'amy-theme'),
               // 'desc'      => __('<p class="description">This is the Description. Again HTML is allowed</p>', 'amy-theme'),
                'fields'    => array(
                    array(
                        'id'        => 'opt-raw-info',
                        'type'      => 'raw',
        ...
        public function setHelpTabs() {
            ...
            $this->args['help_tabs'][] = array(
                'id'        => 'redux-help-tab-1',
                'title'     => __('Theme Information 1', 'amy-theme'),
                'content'   => __('<p>This is the tab content, HTML is allowed.</p>', 'amy-theme')
            );

            $this->args['help_tabs'][] = array(
                'id'        => 'redux-help-tab-2',
                'title'     => __('Theme Information 2', 'amy-theme'),
                'content'   => __('<p>This is the tab content, HTML is allowed.</p>', 'amy-theme')
            );

            // Set the help sidebar
            $this->args['help_sidebar'] = __('<p>This is the sidebar content, HTML is allowed.</p>', 'amy-theme');
        }
        ...
        public function setArguments() {
            ...
            $this->args = array(
                ...
                'opt_name'          => 'ab_amy_settings',            // This is where your data is stored in the database and also becomes your global variable name.
                ...
                'menu_title'        => __('AMY Settings', 'amy-theme'),
                'page_title'        => __('AMY Settings', 'amy-theme'),
            ...
            $this->args['share_icons'][] = array(
                'url'   => 'https://www.facebook.com/pages/Cray-Themes/831476770204620',
                'title' => 'Like us on Facebook',
                'icon'  => 'el-icon-facebook'
            );
            $this->args['share_icons'][] = array(
                'url'   => 'https://twitter.com/CRAYbg',
            ...
            /*if (!isset($this->args['global_variable']) || $this->args['global_variable'] !== false) {
                ...
                $this->args['intro_text'] = sprintf(__('<p>Did you know that Redux sets a global variable for you? To access any of your saved options from within your code you can use your global variable: <strong>$%1$s</strong></p>', 'amy-theme'), $v);
            } else {
                $this->args['intro_text'] = __('<p>This text is displayed above the options panel. It isn\'t required, but more info is always better! The intro_text field accepts all HTML.</p>', 'amy-theme');
            }*/

            // Add content after the form.
     //       $this->args['footer_text'] = __('<p>This text is displayed below the options panel. It isn\'t required, but more info is always better! The footer_text field accepts all HTML.</p>', 'amy-theme');
        }
