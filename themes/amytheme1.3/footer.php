...
<div id="footer" class="bottomnavanim <?php echo $ab_amy_settings['body-color-scheme'];?> <?php if($ab_amy_settings['footer-position'] == "absolute"){ echo "absolutefooter";}?> <?php if($ab_amy_settings['footer-width'] == "boxed"){ echo "boxedstyle";}?>"><?php 
	...
	<div class="right-bottom-nav  <?php echo $ab_amy_settings['body-color-scheme'];?>">
		<div class="tt-bottom-nav noborder animated fadeOutH" <?php if(!is_single() && !is_page()) {?> data-ot='<?php echo $ab_amy_settings['tr-nav-tooltip'];?>'  data-ot-fixed="true"  data-ot-background="rgba(255,255,255,0.95)" data-ot-border-color="rgba(255,255,255,1)" data-ot-offset="[ 40, -22 ]" data-ot-auto-offset="true" data-ot-tip-joint="bottom center" data-ot-target="true" data-ot-border-radius="0" data-ot-group="rightnav"<?php } ?>><?php 
			if(is_single()) {
				if($post->post_type=='post' || $post->post_type=='portfolio'){	
					...
					if(!empty( $prevPost )){ ?>
						<a class="navposts <?php if (empty( $large_image_url_p[0] )){ echo 'navpostnoimg';}?>" href=" <?php echo $prev_post_url;?>" ><?php 
							...
							<div data-ot='<div class="prevpnav-tip"><?php echo htmlentities($rmnext, ENT_QUOTES, "UTF-8");?><div class="tiptitle"><?php previous_post_link(' %link ');?></div><?php echo "<br>".$prev_post_excerpt;?></div>'   data-ot-fixed="false"  data-ot-background="rgba(255,255,255,0.95)" data-ot-border-color="rgba(255,255,255,1)" data-ot-offset="[ 16, -22 ]" data-ot-auto-offset="true" data-ot-stem-length="12" data-ot-tip-joint="bottom center" data-ot-target="true" data-ot-border-radius="0" data-ot-group="rightnav">
    ...
    <div class="footerwidget">
        <div class="wpb_row vc_row-fluid ss-stand-alone"><?php 
			if($ab_amy_settings['footer-layout'] == 5){?>
                ...
                <div class="vc_col-sm-8 wpb_column column_container ccscroll">
                    <?php dynamic_sidebar('footer-1'); ?>
                </div>
                <div class="vc_col-sm-8 wpb_column column_container ccscroll">
                    <?php dynamic_sidebar('footer-2'); ?>
                ...
                <div class="vc_col-sm-6 wpb_column column_container ccscroll">
                    <?php dynamic_sidebar('footer-1'); ?>
                </div>
                <div class="vc_col-sm-6 wpb_column column_container ccscroll">
                    <?php dynamic_sidebar('footer-2'); ?>
				...
				<div class="vc_col-sm-12 wpb_column column_container ccscroll">
					<?php dynamic_sidebar('footer-1'); ?>
				</div><?php 
			}?>
		</div> 
...
<?php include(get_template_directory().'/inc/java-fun.php');?>             
<?php wp_footer();?>
</body>
</html>